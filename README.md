...
Neubofy booking and scheduling app for managing meetings on Cloudflare, with Google Calendar and Outlook Calendar integration.

![Neubofy Booking Page](static/screenshot.png)

**[Live Demo](https://neubofy-booking.pages.dev)**
...
1. Go to [Cloudflare Dashboard](https://dash.cloudflare.com) > **Pages** > **neubofy-booking** > **Custom domains**
2. Add your domain
...
This will sync with the upstream project and automatically deploy to Cloudflare.
...
Neubofy Booking supports Microsoft Outlook Calendar in addition to Google Calendar. You can use Google alone, Outlook alone, or both together. When both are connected, availability is checked across both calendars.

### Setup Microsoft OAuth

1. Go to [Azure Portal](https://portal.azure.com/) > **App registrations** > **New registration**
2. Name: `Neubofy Booking` (or your preferred name)
